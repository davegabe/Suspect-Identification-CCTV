...
GALLERY_THRESHOLD = 0.28 # Threshold used to decide if a face is in the gallery (to decide a known identity)
...
USE_GUI = True # If True, the GUI is used to show the results