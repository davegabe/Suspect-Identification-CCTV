...
from modules.frame_selection_module import select_best_frames
...
def main2():
    ...
    for environment in  protocols.keys():
        ...
        for frame in frames:
            ...
            # Pick the best frame
            best_frames = select_best_frames(camera_frames)
            for numCam, best_frame in enumerate(best_frames):
                ...
                for i, identity in enumerate(identities):
                    ...
                    plt.imsave('results/' + f"_{numCam}_" + frame + ".png", best_frame)
                    plt.close()
